...
var10000就是我们实现代理逻辑的MethodInterceptor类。在MethodInterceptor类的invoke方法中，应该通过MethodProxy来调用被代理类的方法，如果调用的是method，那么将会发生循环调用而发生栈溢出。
